...
Проєкт демонструє технічний підхід до роботи з відкритими закупівельними даними. У репозиторії використовуються лише синтетичні приклади даних.

Реальні контактні списки, приватні файли, кеші API та результати обробки не включаються до репозиторію. Для практичного використання користувач має самостійно дотримуватися правил ділової комунікації та вимог законодавства у своїй юрисдикції.
